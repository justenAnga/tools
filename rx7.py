...
# [+] Dana : 089622155832
# [+] Thanks Buat Yang Dah Bantu Donasi ðŸ˜
...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    android_versi = str(rr(3,13))
    build_versi =random.choice(['OPM1','TP1A','RP1A','PPR1','PKQ1','QP1A','SP1A','RKQ1','MMB29M','JZO54K','LMY47V','LMY48B','LRX22C','LRX21V','LRX22G','LRX21T'])
    chrome_versi = f"{str(rr(70,114))}.0.{str(rr(3000,5999))}.{str(rr(10,299))}"
    instagram_versi = f"{str(rr(100,299))}.0.0.{str(rr(10,99))}.{str(rr(10,599))}"
    u1 = f'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Mobile Safari/537.36'
    u2 = f'Mozilla/5.0 (Linux; Android 8.1.1; Redmi 11 Lite Build/LMY47X) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.565575.109 Mobile Safari/537.36'
    u3 = f'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Mobile Safari/537.36'
    u4 = f'Mozilla/5.0 (Linux; Android 8.1.1; Redmi 11 Lite Build/LMY47X) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.565575.109 Mobile Safari/537.36'
    uaku2 = random.choice([u1, u2, u3, u4])
    ugen.append(uaku2)
...
def get_komen(url,cokies):
	...
	for z in data.find_all("a",href=True):
		if "Lihat komentar lainnyaâ€¦" in z.text or "Lihat komentar sebelumnyaâ€¦'" in z.text:
